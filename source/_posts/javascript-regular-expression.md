---
title: JS 正则表达式完整教程
date: 2019-04-06 22:14:02
tags: regular
---

转载自: [https://juejin.im/post/5965943ff265da6c30653879](https://juejin.im/post/5965943ff265da6c30653879)
...
{% asset_img 3-3-3-chrome-log.webp %}
...
{% asset_img 4-1-1.webp %}

而当目标字符串是 "abbbc" 时，就没有所谓的 “回溯”。其匹配过程是：

{% asset_img 4-1-2.webp %}
...
{% asset_img 4-3-2-1.webp %}

目标字符串是 "12345"，匹配过程是：

{% asset_img 4-3-2-2.webp %}
...
{% asset_img 5-2-1-1.webp %}

应该修改成:

{% asset_img 5-2-1-2.webp %}
...
{% asset_img 5-2-2-1.webp %}

此时要修改成：

{% asset_img 5-2-2-2.webp %}
...
{% asset_img 6-3-2-1.webp %}

如果要求不匹配 +.2 和 -.2，此时正则变成：

{% asset_img 6-3-2-2.webp %}
...
{% asset_img 6-4-1-1.webp %}

如果正则用的是：`/".*?"/`，会产生 2 次回溯（粉色表示`.*?`匹配的内容）：

{% asset_img 6-4-1-2.webp %}
...
[《JavaScript Regular Expressions》](https://book.douban.com/subject/26630579/)，为数不多转讲 JS 正则的。页数不多，也有收获。
...
**[Regulex，一款可视化工具](https://jex.im/regulex/#!flags=&re=%5E&#40;a%7Cb&#41;&#42;%3F%24)
[ProcessOn - 免费在线作图，实时协作](https://www.processon.com/)
[LICEcap – 灵活好用，GIF 屏幕录制工具](https://www.appinn.com/licecap/)** 
